...
/**
 * ============================================================
 *  ЗАНЖИРНИНГ ОХИРГИ ҲАЛҚАСИ: 3 ОЙДАН КЕЙИН ТЕКШИРИШ
 *
 *  ── Нега керак бўлди ──
 *
 *  Схемада «JOYLASHTIRILDI → TASDIQLANDI: жойлаштирилгани 3
 *  ойдан кейин текширилди ва тасдиқланди» деб ёзилган эди.
 *  Аммо у ФАҚАТ қўлда белгиланарди — яъни биров эслаб қолиши
 *  керак эди.
 *
 *  Ҳеч ким эсламади. Одамлар тўртинчи ойдан бери
 *  «жойлаштирилди» да ётаверди ва улар ҳақиқатан ишда
 *  қолганми, ёки бир ҳафтада чиқиб кетганми — ҳеч ким
 *  билмасди. Ҳолбуки бандлик ишининг МАЪНОСИ шунда:
 *  жойлаштириш эмас, ишда ҚОЛИШ.
 *
 *  Энди жойлаштириш ўз-ўзидан топшириқ туғдиради. Муддати —
 *  ишга кирган кундан 90 кун. Муддат ўтса, у кечиккан
 *  топшириқлар қаторига тушади ва ҳокимнинг панелида қизил
 *  бўлиб кўринади.
 *
 *  ── Нега айнан топшириқ ──
 *
 *  Алоҳида эслатма механизми ясаш мумкин эди, лекин топшириқ
 *  тизими аллақачон бор: унда муддат, масъул, кечикиш
 *  ҳисоби, Telegram хабарномаси ва ҳокимнинг кесими бор.
 *  Янги механизм буларнинг ҳаммасини қайтадан ясашни талаб
 *  қиларди.
 * ============================================================
 */

/** Жойлаштиргандан кейин шунча кун ўтиб текширилади */
export const MUSTAHKAMLASH_KUN = 90;

export interface JoylashganManbai {
  ishsizId: string;
  householdId: string | null;
  fish: string;
  ishJoyi: string | null;
...
/** Мустаҳкамлаш текшируви топшириғи */
export function mustahkamlashChorasi(p: JoylashganManbai): YangiChora {
  const boshi = p.ishgaKirganSana ?? new Date();
  const muddati = new Date(boshi);
  muddati.setDate(muddati.getDate() + MUSTAHKAMLASH_KUN);

  return {
    householdId: p.householdId,
    ishsizId: p.ishsizId,
    /*
     * Муаммо матни ТАКРОР аниқлашнинг калити: шу фуқаро учун
     * шу матн бор бўлса, иккинчи топшириқ яратилмайди.
     */
    muammo: `${p.fish} — иш жойида мустаҳкамланиши текширилмаган`,
    sababi: p.ishJoyi
      ? `${p.ishJoyi} га жойлаштирилди. Ишда қолгани тасдиқланиши керак.`
      : 'Ишга жойлаштирилди. Ишда қолгани тасдиқланиши керак.',
    yechim:
      'Бандлик маркази фуқаро билан боғланиб, иш жойида ишлаётганини аниқласин. Ишлаётган бўлса ҳаёт сикли «Тасдиқланди» га ўтказилсин; чиқиб кетган бўлса сабаби ёзилиб, қайта суҳбатга олинсин',
    masulTashkilot: 'Bandlik markazi',
    muddat: muddati,
  };
}
