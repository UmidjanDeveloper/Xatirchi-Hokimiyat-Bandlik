...
export const MASUL_TASHKILOT = v(
   ...
   *
   * Илгари масъул эркин матн эди ва «Xalq ta’limi» билан
   * «Ta'lim bo'limi» кесимда ИККИ ТАШКИЛОТ бўлиб турарди.
   * Энди танилмагани биргина «Бошқа» га тушади — йўқотилмайди,
   * лекин кесимни ҳам ифлос қилмайди.
   */
  ['Boshqa', 'Бошқа ташкилот']
);
