  ...
  return (
    <div className="space-y-4">
      ...
      >
        ...
        {/*
          IT ёзилганда йўналтириш саволи очилади — худди хатлов
          формасидагидек. Маҳалла ходими белгилаган бўлса, бу
          ерда кўриниб туради ва мутахассис уни ЎЧИРМАСЛИГИ
          керак.

          Бу ИСТАК, ваучернинг ўзи эмас. Ваучер юқоридаги
          алоҳида блокда — рақами, йўналиши ва ҳолати билан.
          Иккови ажратилган: бу ерда «ҳа» туриб, ваучер блоки
          бўш бўлса — демак фуқаро ҳали кутяпти, ва у бандлик
          панелидаги навбатда кўриниб туради.
        */}
          ...
          <ToliqKeng>
            <div className="space-y-2.5 rounded-md border border-accent bg-accent-soft p-3.5">
              <p className="text-xs text-ink-muted">
                {tr('IT йўналиши — гуруҳ тўлишини кутиш шарт эмас. IT-шаҳарчада ВАУЧЕР билан текинга ўқитиш мумкин, битта одамни ҳам.')}
              </p>
              <HaYoqMaydoni
                yorliq={tr("IT-шаҳарчага йўналтирилсинми")}
                qiymat={h.itShaharchaVaucheri}
                ozgardi={(q) => yangila('itShaharchaVaucheri', q)}
              />
              <p className="text-[11px] text-ink-faint">
                {tr('Ваучернинг ўзи юқоридаги «IT-шаҳарча ваучери» блокидан берилади.')}
              </p>
            </div>
          </ToliqKeng>
        )}
