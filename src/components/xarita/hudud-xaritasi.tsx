 ...
 *
 * Кейин 22 га туширилди — тикан кетди, аммо ҳамон ҳар бир
 * ҳудуд ўз деворини кўтариб турарди ва харита ғадир-будир
 * кўринарди.
 *
 * Ўн икки бирлик — харита энининг бир фоизи. Ҳажм кўз учун
 * етарли: ағдарилган текислик, юмшоқ соя ва қиймати юқори
 * ҳудудларда сезиладиган кўтарилиш. Аммо харита энди
 * РЕЛЬЕФ эмас, РАНГЛИ ХАРИТА — асосий маълумотни ранг
 * беради, баландлик уни фақат қўллаб туради.
 */
const ENG_BALAND = 12;

/**
 * Маълумоти йўқ ҳудуднинг баландлиги.
 *
 * Ноль: у ерда ўлчанадиган нарса йўқ, шунинг учун кўтариш
 * ҳам йўқ. Бир пайтлар бу уч бирлик эди — «харита оппоқ
 * қоғозга ўхшамасин» деб. Оқлик эса бошқа йўл билан
 * тузатилди: маълумотсиз ҳудуднинг ўз ранги бор. Баландлик
 * фақат ҚИЙМАТ учун қолди.
 */
const ASOS_BALAND = 0;
...
export function HududXaritasi({
  ...
  /*
   * ══════════════════════════════════════════════════════════
   *  КАМЕРАНИ СУРГАБ БУРИШ — ВА БОСИШНИ ЎЛДИРМАСЛИК
   * ══════════════════════════════════════════════════════════
   *
   *  ── Қандай нуқсон бўлган ──
   *
   *  Илгари `setPointerCapture` сичқонча БОСИЛИШИ БИЛАН
   *  чақириларди. Ушлаб олингач, браузер кейинги барча
   *  кўрсаткич ҳодисасини — шу жумладан `click` ни ҳам —
   *  ушлаб олган элементга юборади. Яъни фойдаланувчи ҳудудни
   *  босади, ҳодиса эса ҳудудга эмас, саҳна `div` ига тушади
   *  ва ҳудуднинг `onClick` и ҲЕЧ ҚАЧОН ишламайди.
   *
   *  Экранда ҳамма нарса жойида кўринади: ҳудуд сичқонча
   *  остида кўтарилади, тултип чиқади — фақат босилмайди.
   *
   *  ── Нега синов топмади ──
   *
   *  Синов аввал рўйхатдан МФЙ танлаб, кейин харитага босиб,
   *  карточкани ўқиган эди. Карточка ўрнида турарди — аммо у
   *  РЎЙХАТДАН танланганича қолган эди, харита боскани учун
   *  эмас. Синов «ишлаяпти» деб ёзди, аслида ишламасди.
   *
   *  Энди синов бўш ҳолатдан бошланади: ҳеч нима танланмаган
   *  жойдан харитага босилади ва карточка ПАЙДО БЎЛИШИ
   *  текширилади.
   *
   *  ── Ечим ──
   *
   *  Ушлаб олиш фақат одам ҲАҚИҚАТДА сургаганда — бармоқ ёки
   *  сичқонча тўрт пикселдан ортиқ силжигач — бошланади.
   *  Оддий босишда ушлаб олиш умуман бўлмайди ва `click`
   *  ҳудудга боради.
   */

  /** Шундан ортиқ силжиса — бу босиш эмас, суриш */
  const SURISH_CHEGARASI = 4;

  const sudrashBoshi = (e: React.PointerEvent) => {
    if (!uch) return;
    sudrash.current = { x: e.clientX, y: e.clientY, ...kamera };
    /* `setSudralmoqda` ҳали чақирилмайди: ҳозирча бу оддий босиш */
  };
  ...
  const sudrashDavomi = (e: React.PointerEvent) => {
    ...
    if (!sudralmoqda) {
      if (Math.hypot(dx, dy) < SURISH_CHEGARASI) return;
      /*
       * Мана энди ушлаб оламиз: одам сургаётгани аниқ бўлди.
       * Ушлаб олиш сичқонча харита четидан чиқиб кетса ҳам
       * буришни узилмас қилади.
       */
  ...
  const sudrashOxiri = (e: React.PointerEvent) => {
    if (sudralmoqda) {
