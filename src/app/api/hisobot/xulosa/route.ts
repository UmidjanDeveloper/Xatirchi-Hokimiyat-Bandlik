...
export async function POST(request: Request) {
  ...
  try {
    const hisobot = await hisobotOl({
      ...
      /*
       * «Янгила» — кешни четлаб ўтиш.
       *
       * Илгари бу майдон сўровда қабул қилинарди-ю, ҳеч қаерга
       * узатилмасди: фойдаланувчи тугмани босар, экранда эса
       * ўн беш дақиқалик эски матн турарди ва у «тугма
       * ишламайди» деб ўйларди.
       */
      yangila: d.yangila,
    });
